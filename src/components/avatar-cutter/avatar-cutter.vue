...
.c-avatar-cutter .title {
  font-size: 16px;
  margin-bottom: 20px;
}
.c-avatar-cutter .content {
  display: flex;
  height: 350px;
}
...
.c-left .x-line li:nth-child(1):before,
.c-left .x-line li:nth-last-child(1):before,
.c-left .y-line li:nth-child(1):before,
.c-left .y-line li:nth-last-child(1):before {
  position: absolute;
  margin-left: -3px;
  margin-top: -3px;
  width: 6px;
...
.c-left .x-line li:nth-child(1) {
  cursor: n-resize;
}
.c-left .x-line li:nth-child(1):before {
  left: 50%;
}
.c-left .x-line li:nth-last-child(1) {
  cursor: s-resize;
}
.c-left .x-line li:nth-last-child(1):before {
  left: 50%;
}
.c-left .y-line li:nth-child(1) {
  cursor: w-resize;
}
.c-left .y-line li:nth-child(1):before {
  top: 50%;
}
.c-left .y-line li:nth-last-child(1) {
  cursor: e-resize;
}
.c-left .y-line li:nth-last-child(1):before {
  top: 50%;
...
.c-left .point li:nth-child(1) {
  top: 2px;
  left: 1px;
  cursor: nw-resize;
}
.c-left .point li:nth-child(2) {
  top: 2px;
  right: -2px;
  cursor: ne-resize;
}
.c-left .point li:nth-child(3) {
  bottom: -2px;
  left: 1px;
  cursor: sw-resize;
}
.c-left .point li:nth-child(4) {
  bottom: -2px;
  right: -2px;
  cursor: se-resize;
}
...
.c-btn-group .btn-cancel {
  background-color: #cccccc;
}
.c-btn-group .btn-enter {
  background-color: #56b962;
}
.c-btn-group .btn-enter--disable {
  cursor: not-allowed;
}
</style>
      ...
      <div class="content">
        <div class="c-left" :class="{'c-left--doing':imgURL}">
          <div class="container-box" :style="{
            ...
            <div class="select-box" v-if="imgURL" @mousedown="onMouseDown($event, 'move')" :style="{
        ...
        <div class="c-right">
          ...
          <Upload :before-upload="handleUpload" action="//jsonplaceholder.typicode.com/posts/" style="margin-top:20px" accept="image/*" :format="['jpg','jpeg','png']">
            <Button icon="ios-cloud-upload-outline">{{!imgURL ? '上传图片' : '重新上传'}}</Button>
          </Upload>
        </div>
      </div>
